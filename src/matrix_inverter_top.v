...
module matrix_inverter_top #(
    ...
    input  wire [DATA_WIDTH-1:0] host_data,

    // External Interface to read Final Inverse Matrix
    input  wire [ADDR_WIDTH-1:0] host_Out_addr,
    output wire [DATA_WIDTH-1:0] host_Out_data
);
    ...
    // ------------------------------------------------------------------------
    // 1. MEMORY INSTANTIATIONS (BRAM Banks)
    // ------------------------------------------------------------------------
    ...
    // ------------------------------------------------------------------------
    // 2. NEWTON-RAPHSON INVERSION CORE
    // ------------------------------------------------------------------------
